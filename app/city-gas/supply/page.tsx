...
const CityGasSupplyPage = () => {
	...
	return (
		<section className="min-h-[80vh] mx-auto max-w-4xl px-6 py-10 space-y-6 rounded-2xl border border-gray-300 shadow-2xl bg-white text-neutral-900">
			...
			<div className={`${card} space-y-3`}>
				<div className="flex items-center justify-between">
					<div>
						<div className="text-sm text-neutral-900">예상 총 수수료</div>
